...
const innotech = "/assets/innotech.webp";
const sih = "/assets/SIH.webp";
const nasaspaceapp = "/assets/nasaspaceapp.webp";
const techsamurai = "/assets/techsamurai.webp";
const ieee = "/assets/pranshuieee.webp";
const gsoc = "/assets/gsoc.webp";
const allahabadevent = "/assets/allahabadevents.webp";
const kodekombat = "/assets/kodekombat.webp";
const ideatex = "/assets/Idetatex.webp";
const nitpatna = "/assets/nitpatna.webp";
const sarvinnec = "/assets/sarviniec.webp";
const sidinnovation = "/assets/sidinnovationday.webp";
const BVCOE = "/assets/BVCOEhack.webp";
const kim = "/assets/kimquiz.webp";
const abhinavintern = "/assets/abhinavintern.webp";
const dhruvintern = "/assets/dhruvintern.webp";
